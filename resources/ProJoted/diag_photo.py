...
def main():
    ...
    if temoin:
        ...
        print("  Si les 3 essais photo sont en 404, l'endpoint photo ne sert plus")
        print("  rien sur cet établissement — le client web PRONOTE affiche alors")
        print("  sa silhouette de repli. Rien à corriger côté plugin.")
